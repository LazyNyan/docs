...
The preview on the left updates as you change stuff
...
| Mode | Description |
| --- | --- |
| Always visible | Always on screen, but hides after music is not detected for a while |
| Hide when paused | Hides 2 seconds after music is paused and reappears on play |
| Show when the song changes | Appears when new song starts, then hides after an adjustable duration |
